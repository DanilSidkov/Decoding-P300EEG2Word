...
def EEGNet(
    ...
    dense = Dense(
        nb_classes, name="dense", kernel_constraint=max_norm(norm_rate)
    )(flatten)
...
def DeepConvNet(nb_classes, Chans=64, Samples=256, dropoutRate=0.5):
    ...
    block1 = Conv2D(
        25, (Chans, 1), kernel_constraint=max_norm(2.0, axis=(0, 1, 2))
    )(block1)
    ...
    block2 = Conv2D(
        50, (1, 5), kernel_constraint=max_norm(2.0, axis=(0, 1, 2))
    )(block1)
    ...
    block3 = Conv2D(
        100, (1, 5), kernel_constraint=max_norm(2.0, axis=(0, 1, 2))
    )(block2)
    ...
    block4 = Conv2D(
        200, (1, 5), kernel_constraint=max_norm(2.0, axis=(0, 1, 2))
    )(block3)
